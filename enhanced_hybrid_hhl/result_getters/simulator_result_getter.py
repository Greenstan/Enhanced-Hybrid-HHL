...
class simulator_result_getter(result_getter):
    """
    ...
    def get_result(self,
        ...
        trace_qubits = list(range(hhl_circ.num_qubits-self.observable.num_qubits))
        ...
        result_processed = np.sqrt(partial_simulated_density_matrix.expectation_value(self.observable))
